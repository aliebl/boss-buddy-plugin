...
public class HPOverlay extends Overlay {
    ...
    private void renderTimer(final BossBuddyNPC bossBuddyNPC, final Graphics2D graphics, ArrayList<NPC> stackedNpcs) {
        ...
        if (bossBuddyConfig.npcHideFull() && wNpcHealthRatio == 100) return;
        ...
        if (maxHealth != null) currentHPString += "/"+ maxHealth;
    ...
    private String getCurrentHpString(BossBuddyNPC bossBuddyNPC, boolean numeric) {
        ...
        switch (bossBuddyConfig.decimalHp()) {
            case 1:  return String.valueOf(oneDecimalFormat.format(bossBuddyNPC.getHealthRatio()));
            case 2:  return String.valueOf(twoDecimalFormat.format(bossBuddyNPC.getHealthRatio()));
            default: return String.valueOf((bossBuddyNPC.getHealthRatio() >= 1) ? format.format(bossBuddyNPC.getHealthRatio()) : twoDecimalFormat.format(bossBuddyNPC.getHealthRatio()));
        }
